// ESM entry point that imports the CommonJS serverimport cluster from 'node:cluster';

import { createRequire } from 'module';import os from 'node:os';

const require = createRequire(import.meta.url);import express from 'express';

import compression from 'compression';

// Import the CommonJS serverimport cors from 'cors';

require('./index.cjs');import helmet from 'helmet';
